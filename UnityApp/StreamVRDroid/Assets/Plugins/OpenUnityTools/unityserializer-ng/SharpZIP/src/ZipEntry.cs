...
namespace ICSharpCode.SharpZipLib.Zip
{
	...
	/// </summary>
	public class uZipEntry : ICloneable
	{
		[Flags]
		enum Known : byte
		{
		...
		/// The name passed is null
		/// </exception>
		internal uZipEntry(string name, int versionRequiredToExtract)
		...
		/// </remarks>
		internal uZipEntry(string name, int versionRequiredToExtract, int madeByInfo,
...
//				return (byte[]) extra.Clone();
		...
		public object Clone()
		{
			uZipEntry result = (uZipEntry)this.MemberwiseClone();
